...
int main() {
				...
				new ui::ButtonWithPanel {
					...
					new ui::LayerWithPanel{
						...
						new ui::ConstPanel{
							...
							new ui::Sizing2{sf::Vector2f{0.5, 0.5}, sf::Vector2f{}},
							new ui::Positioning2{ui::Location2::upRight, ui::Location2::upLeft}
						}
					}
				},
				new ui::ClickHidePanelInteraction{sf::Mouse::Left},
				new ui::Sizing2{true},
				new ui::Positioning2{ui::Location2::upRight, ui::Location2::upLeft, {-5, 5}}
			},
			new ui::PointingDisplayPanelInteraction{},
	...
	while(window.isOpen()) {
		...
		interface.draw();
		//interface.drawDebug(window, 0, 2, 0, 60);
		window.display();
	}
}
