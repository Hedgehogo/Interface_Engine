	...
	bool DecodePointer<BoxWithBorderVertical>::decodePointer(const YAML::Node& node, BoxWithBorderVertical*& boxWithBorderVertical) {
		...
		if(node["objects"]) {
			...
			if(node["bounds"]) {
				...
				{
					boxWithBorderVertical = new BoxWithBorderVertical{objects, bounds, minSize};
					return true;
				}
			} else {
				{
					boxWithBorderVertical = new BoxWithBorderVertical{objects, minSize};
					return true;
				}
			}
		} else {
			...
			{
				boxWithBorderVertical = new BoxWithBorderVertical{firstObject, secondObject, bound, minSize};
				return true;
			}
		}
	}
