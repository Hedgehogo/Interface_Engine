...
namespace ui {
	...
	public:
		Slider(ui::IUninteractive *slider, ui::IUninteractive *background, const std::shared_ptr<WithCoefficientVec2>& value, sf::Vector2f sliderScale = {1.0f, 0.5f}, Key button = Key::mouseLeft,
		...
		Slider(ui::IUninteractive *slider, ui::IUninteractive *background, const std::shared_ptr<WithCoefficientVec2>& value, sf::Vector2i division, sf::Vector2f sliderScale = {1.0f, 0.5f}, Key button = Key::mouseLeft, bool wheelHorizontal = false);
