...
namespace ui {
	...
	public:
		ConstSlider(IUninteractive *slider, IUninteractive *background, const PSCoefficientVec2& value, float sliderScale = 1.0f, KeyHandler::Key button = KeyHandler::Key::mouseLeft,
		...
		ConstSlider(IUninteractive *slider, IUninteractive *background, const PSCoefficientVec2& value, sf::Vector2i division, float sliderScale = 1.0f, KeyHandler::Key button = KeyHandler::Key::mouseLeft, bool wheelHorizontal = false);
