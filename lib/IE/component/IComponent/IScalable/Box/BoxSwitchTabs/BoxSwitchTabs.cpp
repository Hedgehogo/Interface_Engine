...
namespace ie {
	...
	std::size_t BoxSwitchTabs::get_array_size() const {
		return objects.size();
	}
	
	IScalable& BoxSwitchTabs::get_object_at(std::size_t index) {
		return *objects.at(index);
	}
	
	const IScalable& BoxSwitchTabs::get_object_at(std::size_t index) const {
		return *objects.at(index);
	}
