...
namespace ie {
	namespace make_system {
		...
		BasicKeysInteraction<A_>::BasicKeysInteraction(BoxPtr<IBasicActivityAction<A_> >&& action, std::vector<Key> keys, std::vector<Key> black_list_keys) :
	...
	template<typename A_>
	auto BasicKeysInteraction<A_>::get_action() -> IBasicActivityAction<A_>* {
		return action_.get();
	}
	
	template<typename A_>
	auto BasicKeysInteraction<A_>::set_action(IBasicActivityAction<A_>* action) -> void {
