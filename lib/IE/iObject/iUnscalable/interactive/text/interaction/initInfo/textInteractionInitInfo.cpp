...
namespace ui {
	TextInteractionInitInfo::TextInteractionInitInfo(sf::RenderWindow& window_, sf::RenderTarget& renderTarget_, InteractionManager& interactionManager_, InteractionStack& interactionStack_, IPanelManager& panelManager_, Text& text_) :
	...
	TextInteractionInitInfo TextInteractionInitInfo::copy(sf::RenderWindow& window_) const {
