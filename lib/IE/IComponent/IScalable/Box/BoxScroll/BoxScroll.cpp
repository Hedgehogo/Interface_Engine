...
namespace ie {
	BoxScroll::Make::Make(BoxPtr<IComponent::Make>&& object, PSRVec2f normalObjectPosition, sf::Vector2f minSize) :
	...
	BoxScroll::BoxScroll(BoxPtr<IComponent>&& object, const PSRVec2f& normalObjectPosition, const sf::Vector2f& minSize) :
