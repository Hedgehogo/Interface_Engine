...
namespace ui {
	...
	std::string BufferNonExistentNestingLevelException::getName() const { return name; }
	
	BufferNonExistentNestingLevelException::lSize BufferNonExistentNestingLevelException::getLevel() const { return level; }
	...
	std::string BufferVariableNotFoundException::getName() const { return name; }
	
	std::string BufferVariableNotFoundException::getType() const { return type; }
