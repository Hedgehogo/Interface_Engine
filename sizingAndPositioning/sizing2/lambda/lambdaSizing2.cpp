...
namespace ui {
	LambdaSizing2::LambdaSizing2(sf::Vector2f (*findSize)(sf::Vector2f parentSize, sf::Vector2f targetSize, sf::Vector2f normalSize)) : sizing(findSize), renderTarget(nullptr), normalSize() {}
	...
	LambdaSizing2 *LambdaSizing2::copy() {
		LambdaSizing2* lambdaSizing2{new LambdaSizing2{sizing}};
