...
#include <IE/IComponent/IUnscalable/IScalable/Box/BoxRenderTexture/BoxRenderTexture.hpp>
#include <IE/IComponent/IUnscalable/IScalable/IUninteractive/OnlyDrawable/FullColor/FullColor.hpp>
#include <_test/IComponent/_InitInfoData/InitInfoData.hpp>
#include <_test/_imageEqual.hpp>

TEST(IObject, BoxRenderTexture) {
	InitInfoData data{{100, 100}};
	
	ui::BoxRenderTexture boxRenderTexture{
