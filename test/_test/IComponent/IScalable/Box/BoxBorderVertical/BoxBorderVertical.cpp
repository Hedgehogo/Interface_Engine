...
TEST(IComponent, BoxBorderVertical) {
	...
	box_border_vertical.resize({7, 13}, {23, 41});
	ASSERT_EQ(box_border_vertical.get_size(), (sf::Vector2f{7, 13}));
	ASSERT_EQ(box_border_vertical.get_area_size(), (sf::Vector2f{7, 13}));
