...
TEST(Sprite, draw) {
    ...
    testTexture.loadFromFile("../test/tests/7-stage-object/IE/iObject/iUnscalable/iScalable/uninteractive/onlyDrawable/sprite/src/gigachad.jpg");
...
TEST(Sprite, YAML) {
    Program testProgram{
	    new ui::Interface{
            ui::loadFromYaml<ui::IScalable>("../test/tests/7-stage-object/IE/iObject/iUnscalable/iScalable/uninteractive/onlyDrawable/sprite/src/test.yaml")
        }
    };
    ...
    sf::Image testImage;
    testImage.loadFromFile("../test/tests/7-stage-object/IE/iObject/iUnscalable/iScalable/uninteractive/onlyDrawable/sprite/src/gigachad.jpg");
