...
namespace ui {
	...
	Caption::Caption(const std::wstring& text, OnlyDrawable *background, sf::Font &font, int size, sf::Color color, sf::Text::Style style, float rotation) :
	...
	Caption::Caption(sf::Text text, OnlyDrawable *background, std::wstring str, sf::Vector2f minimumSize) : text(text), background(background), str(str), minimumSize(minimumSize) {}
