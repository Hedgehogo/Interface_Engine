...
namespace ui {
	...
	Caption::Caption(const std::wstring& text, IDrawable *background, sf::Font &font, sf::Vector2f minimumSize, int size, sf::Color color, sf::Text::Style style, float rotation) :
	...
	Caption::Caption(const std::wstring& text, IDrawable *background, sf::Font &font, int size, sf::Color color, sf::Text::Style style, float rotation) :
	...
	Caption::Caption(sf::Text text, IDrawable *background, std::wstring str, sf::Vector2f minimumSize) : text(text), background(background), str(str), minimumSize(minimumSize) {}
	
	Caption *Caption::copy() {
		Caption* caption{new Caption{text, background, str, minimumSize}};
		IDrawable::copy(caption);
		return caption;
	}
