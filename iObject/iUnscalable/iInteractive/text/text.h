...
#include "../../iScalable/iDrawable/iDrawable.h"
#include "../../iScalable/iDrawable/fullColor/fullColor.h"

namespace ui {
	class Text : public IInteractive, public IScalable {
    public:
        enum class Align{
            left,
            right,
    ...
    protected:
        ...
        ui::IDrawable *background;
        void init(sf::RenderTarget &renderTarget, PanelManager &panelManager);
		
    public:
        Text(std::vector<ui::BaseTextBlock *> textBlocks, IDrawable *background = new ui::FullColor(sf::Color::White),
    ...
    protected:
        Text(std::vector<ui::BaseTextBlock *> textBlocks, IDrawable *background = new ui::FullColor(sf::Color::White), uint size = 14, float lineSpacing = 1.15, ui::Text::Align align = Align::left);
